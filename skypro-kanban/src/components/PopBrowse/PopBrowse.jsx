				...
				<div className="pop-browse__block">
					<div className="pop-browse__content">
						...
						<div className="pop-browse__btn-browse ">
							...
							<button className="btn-browse__close _btn-bg _hover01"><Link to={routeObj.MAIN}>Закрыть</Link></button>
						</div>
						<div className="pop-browse__btn-edit _hide">
							...
							<button className="btn-edit__close _btn-bg _hover01"><Link to={routeObj.MAIN}>Закрыть</Link></button>
						</div>
					</div>
				</div>
			</div>
